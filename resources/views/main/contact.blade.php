...
@section('content')
    <div class="section big-55-height over-hide z-bigger">
        ...
        <div class="parallax parallax-top" style="background-image: url('images/bg-about.jpg')"></div>
        ...
        <div class="container">
            <div class="row justify-content-center padding-bottom-smaller">
                ...
                <div class="col-md-8 text-center mt-5" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.2s">
                    ...
                    <h2 class="text-opacity">+381 64 13 12 570</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-8">
